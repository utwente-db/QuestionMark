...
To view and download the two projects, select either the branch _thedatasetgenerator_ or _theprobabilisticbenchmark_ and clone each branch in its own project. Follow the instructions provided by the manual in each project carefully.
