...
def sort_offers(jsonzip):
    ...
    with open('datasets/offers_corpus_english_v2_sorted.json', 'w', encoding='utf-8') as file:
...
if __name__ == '__main__':
    ...
    sort_offers('datasets/offers_corpus_english_v2.json.gz')  # normal execution.
